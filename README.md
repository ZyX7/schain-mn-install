...
```bash
masternodename ipaddress:10021 genkey collateralTxID outputID
```

An example would be

```
mn1 127.0.0.2:10021 93HaYBVUCYjEMeeH1Y4sBGLALQZE1Yc1K64xiqgX37tGBDQL8Xg 2bcd3c84c84f87eaa86e4e56834c92927a07f9e18718810b92e0d0324456a67c 0
```
...
```bash
bash <( curl https://raw.githubusercontent.com/ZyX7/schain-mn-install/master/install.sh )
```
